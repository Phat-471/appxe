...
object VietnamTrafficData {
  ...
  val EXTENDED_CAMERAS: List<TrafficCamera> = listOf(
    ...
    TrafficCamera("cam_sg_lbb_lythanhtong_01", 10.7675, 106.6355, CameraType.RED_LIGHT_CAMERA, "Lũy Bán Bích giao Lý Thánh Tông - Bùi Cẩm Hổ", 50, "Camera phạt nguội vượt đèn đỏ và đi sai làn ngã tư Lý Thánh Tông", "Tân Phú, TP.HCM", fineAmountText = "Phạt 800.000đ - 1.000.000đ (Xe máy)"),
    TrafficCamera("cam_sg_lbb_01", 10.7725, 106.6342, CameraType.RED_LIGHT_CAMERA, "Lũy Bán Bích giao Thoại Ngọc Hầu", 50, "Camera phạt nguội vượt đèn đỏ và đè vạch người đi bộ ngã tư Thoại Ngọc Hầu", "Tân Phú, TP.HCM", fineAmountText = "Phạt 800.000đ - 1.000.000đ (Xe máy) / 4-6 triệu (Ô tô)"),
    ...
    TrafficCamera("cam_sg_lbb_auco_01", 10.7890, 106.6300, CameraType.RED_LIGHT_CAMERA, "Lũy Bán Bích giao Âu Cơ", 50, "Camera phạt đèn đỏ và lấn làn đầu đường Lũy Bán Bích", "Tân Phú, TP.HCM", fineAmountText = "Phạt 800.000đ - 1.000.000đ"),
